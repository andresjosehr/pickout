...
form.classList.add('was-validated')},!1)});var bookingCoreApp={showSuccess:function(configs){var args={};if(typeof configs=='object')
{args=configs}else{args.message=configs}
if(!args.title){args.title=i18n.success}
args.centerVertical=!0;bootbox.alert(args)},showError:function(configs){var args={};if(typeof configs=='object')
{args=configs}else{args.message=configs}
if(!args.title){args.title=i18n.warning}
args.centerVertical=!0;bootbox.alert(args)},showAjaxError:function(e){var json=e.responseJSON;if(typeof json!='undefined'){if(typeof json.errors!='undefined'){var html='';_.forEach(json.errors,function(val){html+=val+'<br>'});return this.showError(html)}
...
{args=configs}
args.buttons={confirm:{label:'<i class="fa fa-check"></i> '+i18n.confirm,},cancel:{label:'<i class="fa fa-times"></i> '+i18n.cancel,}};args.centerVertical=!0;bootbox.confirm(args)}}