...
class HomeController extends Controller
{
    ...
    public function updateTo120(){
        ...
        Permission::findOrCreate('gastronomia_view');
        Permission::findOrCreate('gastronomia_create');
        Permission::findOrCreate('gastronomia_update');
        Permission::findOrCreate('gastronomia_delete');
        Permission::findOrCreate('gastronomia_manage_others');
        // Vendor
        $vendor = Role::findOrCreate('vendor');
        $vendor->givePermissionTo('gastronomia_create');
        $vendor->givePermissionTo('gastronomia_view');
        $vendor->givePermissionTo('gastronomia_update');
        $vendor->givePermissionTo('gastronomia_delete');
        // Admin
        $role = Role::findOrCreate('web');
        $role->givePermissionTo('gastronomia_view');
        $role->givePermissionTo('gastronomia_create');
        $role->givePermissionTo('gastronomia_update');
        $role->givePermissionTo('gastronomia_delete');
        $role->givePermissionTo('gastronomia_manage_others');
...
<a href="mailto:info@pickout.cl">info@pickout.cl</a>',
                    'group' => "general",
                ]
            );
        }
