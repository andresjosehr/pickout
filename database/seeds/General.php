...
<a href="mailto:info@pickout.cl">info@pickout.cl</a>',
                    ...
                    [
                        ...
                        'val' => "<!DOCTYPE html><html><head></head><body><h3>PickOut</h3><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>&nbsp;</p><p>Tell. + 00 222 444 33</p><p>Email. hello@yoursite.com</p><p>1355 Market St, Suite 900San, Francisco, CA 94103 United States</p></body></html>",
                        'group' => "general",
                    ],
                    [
			...
			[
				...
				[
					'name'  => "email_header",
					'val'   => '<h1 class="site-title" style="text-align: center">PickOut</h1>',
					'group' => "general",
				],
				[
					'name'  => "email_footer",
					'val'   => '<p class="" style="text-align: center">&copy; 2019 PickOut. All rights reserved</p>',
					'group' => "general",
				],
				[
