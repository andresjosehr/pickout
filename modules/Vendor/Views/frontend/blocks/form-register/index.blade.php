    ...
    <div class="bravo-vendor-form-register py-5 @if(!empty($layout)) {{ $layout }} @endif">
        <div class="row">
            <div class="col-12 col-lg-5">
                ...
                <form class="form bravo-form-register-vendor ggggg" method="post" action="{{route('vendor.register')}}">
                    @csrf
            ...
            <div class="col-12 col-lg-6">
                <div class="bravo_gallery">
                    <div class="btn-group">
                        @if($youtube)
                            <a href="#" class="btn-transparent has-icon bravo-video-popup" data-toggle="modal" data-src="{{ str_ireplace("watch?v=","embed/",$youtube) }}" data-target="#video-register">
                                @if($bg_image)
