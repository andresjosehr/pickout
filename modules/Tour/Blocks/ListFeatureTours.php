...
class ListFeatureTours extends BaseBlock
{
    ...
    {
        return __('Tour: List Feature Tours');
    }

    public function content($model = [])
    {
        $model_Tour = Tour::select("bravo_tours.*")->with(['location','translations','hasWishList'])->where("is_featured", 1);
        ...
        return view('Tour::frontend.blocks.list-feature-tour.index', $data);
    }
}
