        ...
        <div class="row">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input type="phone" value="{{$row->phone}}" placeholder="{{__("Example: 3")}}" name="phone" class="form-control">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input type="email" value="{{$row->email}}" placeholder="{{__("Example: 5")}}" name="email" class="form-control">
            ...
            <div class="col-md-4">
                ...
                <div class="form-group">
                    ...
                    <input type="url" value="{{$row->website}}" placeholder="{{__("Example: 100")}}" name="website" class="form-control">
...
@include('Space::admin/space/menu')


@include('Space::admin/space/hours_open')
