...
@section('content')
    ...
    <form action="{{route('gastronomia.admin.store',['id'=>($row->id) ? $row->id : '-1','lang'=>request()->query('lang')])}}" method="post">
        ...
        <div class="container-fluid">
            ...
            <div class="d-flex justify-content-between mb20">
                ...
                <div class="">
                    ...
                    <h1 class="title-bar">{{$row->id ? 'Edit: '.$row->name : __("Add new gastronomia")}}</h1>

                    @if($row->slug)

                        <p class="item-url-demo">{{__("Permalink")}}: {{ url( (request()->query('lang') ? request()->query('lang').'/' : '').config('gastronomia.gastronomia_route_prefix'))  }}/<a href="#" class="open-edit-input" data-name="slug">{{$row->slug}}</a></p>
                    ...
                    <div class="col-md-9">
                        ...
                        <div class="panel">
                            ...
                            <div class="panel-body">
                                ...
                                <h3 class="panel-body-title">{{__("Gastronomia Content")}}</h3>

                                @include('Gastronomia::admin/form')
