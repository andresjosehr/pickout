...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="d-flex justify-content-between mb20">
            ...
            <h1 class="title-bar">{{__("Gastronomia")}}</h1>
        ...
        <div class="row">
            ...
            <div class="col-md-4 mb40">
                ...
                <div class="panel">
                    ...
                    <div class="panel-title">{{__("Add Gastronomia")}}</div>

                    <div class="panel-body panel-index">

                        <form action="{{route('gastronomia.admin.store',['id'=>'-1','lang'=>request()->query('lang')])}}" method="post">

                            @csrf

                            @include('Gastronomia::admin/form',['parents'=>$rows])

                            <div class="form-group form-index-hide">

                                <label class="control-label">{{__("Gastronomia Map")}}</label>
                                ...
                                <p><i>{{__('Click onto map to place Gastronomia address')}}</i></p>
                ...
                <div class="filter-div d-flex justify-content-between ">
                    ...
                    <div class="col-left">
                        ...
                        @if(!empty($rows))
                            ...
                            <form method="post" action="{{url('admin/module/gastronomia/editBulk')}}"
                    ...
                    <div class="col-left">
                        ...
                        <form method="get" action="{{url('/admin/module/gastronomia')}}" class="filter-form filter-form-right d-flex justify-content-end" role="search">
                                ...
                                @if( count($rows) > 0)
                                    ...
                                    <tr>
                                        ...
                                        <td class="title">
                                            ...
                                            <a href="{{url('admin/module/gastronomia/edit/'.$row->id)}}">{{$prefix.' '.$row->name}}</a>
